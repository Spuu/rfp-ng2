...
var CptyService = (function () {
    ...
    CptyService.prototype.getCpty = function (id) {
        return this.getCpties()
            .map(function (cpties) { return cpties.find(function (c) { return c._id === id; }); });
    };
    CptyService.prototype.handleError = function (error) {
        // in a real world app, we may send the server to some remote logging infrastructure
        // instead of just logging it to the console
        console.error(error);
        return Observable_1.Observable.throw(error.json().error || 'Server error');
    };
    CptyService = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [http_1.Http])
    ], CptyService);
    return CptyService;
}());
exports.CptyService = CptyService;
//# sourceMappingURL=cpty.service.js.map